...
def softmax(z):
    return 1 / (np.sum(np.exp(z), axis=1, keepdims=True) / np.exp(z))
...
if __name__ == '__main__':
    ...
    with open(
            '/Users/mengjiunchiou/Google Drive/NUS/Modules/1718S1/CS5242 Neural Networks and Deep Learning/assignment/assignment1/Question2_4/c/w-100-40-4.csv') as csvfile:
        ...
        with open(
                '/Users/mengjiunchiou/Google Drive/NUS/Modules/1718S1/CS5242 Neural Networks and Deep Learning/assignment/assignment1/Question2_4/c/b-100-40-4.csv') as csvfile:
            r = csv.reader(csvfile, delimiter='\n', quotechar='|')
            i = 0
            j = 0
            for row in r:
    ...
    with open('dW-100-40-4.csv', 'wb') as csvfile:
    ...
    with open('db-100-40-4.csv', 'wb') as csvfile:
        myWriter = csv.writer(csvfile)
