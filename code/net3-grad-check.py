...
def softmax(z):
    ...
    for i in range(z.shape[1]):
        z_t.append(1 / np.sum(np.exp(z - z[0][i]), axis=1))
    z_t = np.asarray(z_t)
...
if __name__ == '__main__':
    ...
    with open(
            '/Users/mengjiunchiou/Google Drive/NUS/Modules/1718S1/CS5242 Neural Networks and Deep Learning/assignment/assignment1/Question2_4/c/w-14-28-4.csv') as csvfile:
        ...
        with open(
                '/Users/mengjiunchiou/Google Drive/NUS/Modules/1718S1/CS5242 Neural Networks and Deep Learning/assignment/assignment1/Question2_4/c/b-14-28-4.csv') as csvfile:
            r = csv.reader(csvfile, delimiter='\n', quotechar='|')
            i = 0
            j = 0
            for row in r:
    ...
    with open('dW-14-28-4.csv', 'wb') as csvfile:
    ...
    with open('db-14-28-4.csv', 'wb') as csvfile:
        myWriter = csv.writer(csvfile)
